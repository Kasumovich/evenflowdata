...
THEMES = {
    ...
    "Prices / costs":        ["prices", "price", "pricing", "inflation", "cost", "costs",
                              "input cost", "input costs", "cost pressure", "cost pressures",
                              "price increase", "price increases", "raw materials",
                              "pass through", "passed on", "margins", "selling prices"],
